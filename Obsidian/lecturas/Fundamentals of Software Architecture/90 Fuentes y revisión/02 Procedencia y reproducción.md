...
Para regenerar los SVG, ejecuta el script con Python 3. Las versiones PNG ya están incluidas para otros lectores. Los veinte diagramas Mermaid se conservan como archivos `.mmd` dentro de `Recursos visuales/Diagramas`, junto con sus SVG y PNG. Cada capítulo inserta el PNG mediante un enlace Markdown relativo y enlaza la fuente editable; así las imágenes también se ven en GitHub sin depender de la sintaxis de embeds de Obsidian.
